export class AppData {
  public static books: any[] = [
    ...
    },
    {
      ...
      image:
        "	https://images-eu.ssl-images-amazon.com/images/I/41hZDooM2zL._SY264_BO1,204,203,200_QL40_FMwebp_.jpg",
    },
    {
      id: 9781449337711,
    ...
    },
    {
      ...
      description:
        "Design and build Web APIs for a broad range of clients—including browsers and mobile devices—that can adapt to change over time. This practical, hands-on guide takes you through the theory and tools you need to build evolvable HTTP services with Microsoft's ASP.NET Web API framework. In the process, you'll learn how design and implement a real-world Web API.",
      website: "http://chimera.labs.oreilly.com/books/1234000001708/index.html",
      image: "https://m.media-amazon.com/images/I/81fPt7grvyL._SY425_.jpg",
    },
    {
      id: 9781449337716,
      ...
      description:
        "Design and build Web APIs for a broad range of clients—including browsers and mobile devices—that can adapt to change over time. This practical, hands-on guide takes you through the theory and tools you need to build evolvable HTTP services with Microsoft's ASP.NET Web API framework. In the process, you'll learn how design and implement a real-world Web API.",
      website: "http://chimera.labs.oreilly.com/books/1234000001708/index.html",
      image: "https://m.media-amazon.com/images/I/71oZ45OrLjL._SY425_.jpg",
    },
    {
      id: 9781449337719,
      ...
      description:
        "Design and build Web APIs for a broad range of clients—including browsers and mobile devices—that can adapt to change over time. This practical, hands-on guide takes you through the theory and tools you need to build evolvable HTTP services with Microsoft's ASP.NET Web API framework. In the process, you'll learn how design and implement a real-world Web API.",
      website: "http://chimera.labs.oreilly.com/books/1234000001708/index.html",
      image: "https://m.media-amazon.com/images/I/71F+8OEEU4L._SY425_.jpg",
    },
    {
      id: 97814493377111,
      ...
      description:
        "Design and build Web APIs for a broad range of clients—including browsers and mobile devices—that can adapt to change over time. This practical, hands-on guide takes you through the theory and tools you need to build evolvable HTTP services with Microsoft's ASP.NET Web API framework. In the process, you'll learn how design and implement a real-world Web API.",
      website: "http://chimera.labs.oreilly.com/books/1234000001708/index.html",
      image: "https://m.media-amazon.com/images/I/81XICRHTu1L._SY425_.jpg",
    },
  ];
}
